...
.logo-btn{display:flex;align-items:left;gap:10px;border:none;background:none;cursor:pointer;padding:0;margin-top:8px;}
.logo-txt .t{font-family:'Sora',sans-serif;font-size:15px;font-weight:800;color:#fff;line-height:1.1;text-align:left;}
.logo-txt .s{font-size:10px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.06em;text-align:left;}
.hsp{flex:1;}
